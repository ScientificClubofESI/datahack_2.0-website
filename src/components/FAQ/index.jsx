...
const FAQ = () => {
  ...
  return (
   <div className="max-w-3xl mx-auto px-4 py-6 border-2 border-transparent" style={{borderImage: 'linear-gradient(90deg, #6F06C1, #4EA4F9, #36D9FF) 1'}}>
      <div className="space-y-2 m-4">
        <h2 className="text-2xl font-bold text-center text-Monotone-White">FAQ</h2>
        <h2 className="text-lg font-semibold text-center text-Primary-300">//Questions</h2>
      </div>
      <div className="space-y-2 m-4">
        {faqs.map((faq, index) => (
