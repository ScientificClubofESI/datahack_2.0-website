...
import partner1 from "../../../public/images/partners/labo.png";
...
const PartnersLMCS = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="text-Monotone-White flex flex-col items-center justify-center gap-10  lg:px-28"
    >
      <div className="flex w-full justify-start items-center flex-col lg:flex-row gap-10 lg:gap-5 max-w-6xl">
        ...
        <div
          ...
          <p className="text-base lg:text-xl font-aspekta font-medium">Laboratoire de Méthodes de Conception de Système</p>
