    ...
    <footer className="relative  flex flex-col items-center py-6 pt-40 gap-20">
      <div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-20 w-full px-6 lg:px-24">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 flex-grow w-full max-w-80 lg:w-fit lg:max-w-full">
          {/* Contact Section */}
          <div className="flex flex-col items-start lg:items-end justify-center py-4 gap-2 lg:gap-6 pl-6 lg:pr-10 lg:pl-0 border-l-2 lg:border-l-0 lg:border-r-4 bg-gradient-to-l lg:bg-gradient-to-r from-transparent to-[#03346620] border-Primary-500  backdrop-blur-[2px] text-Monotone-White flex-grow w-full">
